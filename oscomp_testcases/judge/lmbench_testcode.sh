...
echo -n "lat_mmap -P 1 512k /var/tmp/XXX: "
lmbench_all lat_mmap -P 1 512k /var/tmp/XXX
busybox echo file system latency
lmbench_all lat_fs /var/tmp
busybox echo Bandwidth measurements
lmbench_all bw_pipe -P 1
echo -n "lmbench_all bw_file_rd -P 1 512k io_only /var/tmp/XXX: "
lmbench_all bw_file_rd -P 1 512k io_only /var/tmp/XXX
echo -n "lmbench_all bw_file_rd -P 1 512k open2close /var/tmp/XXX: "
lmbench_all bw_file_rd -P 1 512k open2close /var/tmp/XXX
echo -n "lmbench_all bw_mmap_rd -P 1 512k mmap_only /var/tmp/XXX: "
lmbench_all bw_mmap_rd -P 1 512k mmap_only /var/tmp/XXX
echo -n "lmbench_all bw_mmap_rd -P 1 512k open2close /var/tmp/XXX: "
