...
echo -n "bw_file_rd -P 1 512k io_only /var/tmp/XXX: "
lmbench_all bw_file_rd -P 1 512k io_only /var/tmp/XXX
echo -n "bw_file_rd -P 1 512k open2close /var/tmp/XXX: "
lmbench_all bw_file_rd -P 1 512k open2close /var/tmp/XXX
echo -n "bw_mmap_rd -P 1 512k mmap_only /var/tmp/XXX: "
lmbench_all bw_mmap_rd -P 1 512k mmap_only /var/tmp/XXX
echo -n "bw_mmap_rd -P 1 512k open2close /var/tmp/XXX: "
